...
YSRESULT YsSoundPlayer::SoundData::LoadWav(const char fn[])
{
	...
	fp = fopen(fn, "rb"); // change by Nestor Gomez
...
YSRESULT YsSoundPlayer::SoundData::LoadWav(BinaryInStream &inStream)
{
	...
	//printf("File Size=%d\n",fSize+8);  // change by Nestor Gomez
	...
	//printf("Header Size=%d\n",hdrSize);  // change by Nestor Gomez
	...
	*/
	...
	//printf("Data Size=%d (0x%x)\n",dataSize,dataSize);  // change by Nestor Gomez
